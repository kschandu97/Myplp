...
public class AccountController {
	...
	Account a1 = new Account(101, "9989850232", "chandu", 1000.0);
    Account a2 = new Account(102, "9989850233", "Akhil",  5000.0);
	Account a3 = new Account(103, "9989850234", "Vasthav", 2000.0);
